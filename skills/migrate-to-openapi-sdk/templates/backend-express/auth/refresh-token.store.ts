...
//
// DEMO-GRADE: this is an in-memory Map. Replace with a real persistence
// layer (Redis, a DB table) before this leaves demo/POC status — an
// in-memory store loses every session on restart and doesn't work across
// multiple backend instances (a real concern for Express apps behind a
// load balancer more often than a single NestJS pod).
